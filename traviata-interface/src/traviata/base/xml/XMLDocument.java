...
public class XMLDocument implements Serializable {
	...
	public void loadResource(String pRessourcenname) {
		InputStream stream = openStream(pRessourcenname);
		if (stream == null) {
	...
	private static InputStream openStream(String pRessourcenname) {
		return XMLDocument.class.getResourceAsStream(pRessourcenname);
	}
	...
	public static XMLDocument openResource(String dn) {
		InputStream stream = openStream(dn);
		if (stream == null) {
			return null;
		}
